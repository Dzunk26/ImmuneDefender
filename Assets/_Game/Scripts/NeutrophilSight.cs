...
public class NeutrophilSight : MonoBehaviour {
    ...
    private void OnTriggerEnter(Collider other) {
        if (other.TryGetComponent<BaseBacteria>(out BaseBacteria bacteria)) {
            ...
            if (bacteria is IIntracelullarable intracellularable) {
                intracellularable.OnBecameUntargetable += IUntargetable_OnBecameUntargetable;
                intracellularable.OnBecameTargetable += IUntargetable_OnBecameTargetable;
            }
